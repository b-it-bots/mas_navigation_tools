...
#ifndef MAS_NAVIGATION_TOOLS_PATH_LENGTH_CALCULATOR_H
#define MAS_NAVIGATION_TOOLS_PATH_LENGTH_CALCULATOR_H
...
#endif  // MAS_NAVIGATION_TOOLS_PATH_LENGTH_CALCULATOR_H
